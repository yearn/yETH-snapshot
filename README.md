# yETH snapshot
Python script used to generate the [yETH snapshot](./snapshot.json) at block 23914085.
...
This uses prefetched lists of token balances in order to speed up calculations. These lists can be generated from scratch by uncommenting function calls of functions starting with `populate` inside the `main` function of the [`script`](./scripts/snapshot.py)
